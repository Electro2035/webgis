...
<div class="content">  
    ...
    <script>  
        ...
        $.getJSON("<?=base_url()?>assets/provinsi_pt.geojson",function(data){
            var ratIcon = L.icon({
        ...
        $.getJSON("<?=base_url()?>assets/sungai.geojson",function(data){
            L.geoJson(data,{
         ...
         $.getJSON("<?=base_url()?>/assets/provinsi_pg.geojson",function(kode){
            L.geoJson( kode, {
                style: function(feature){
                  var fillColor,
