...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>assets/web/assets/css/fontawesome.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/web/assets/css/templatemo-woox-travel.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/web/assets/css/owl.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/web/assets/css/animate.css">
...
<body>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="index.html" class="logo">
                        <img src="<?=base_url()?>assets/web/assets/images/logo.png" alt="">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li><a href="<?= site_url('')?>">Home</a></li>
                        <li><a href="<?= site_url('web/about')?>" class="active">About</a></li>
                        <li><a href="<?= site_url('web/deals')?>">Deals</a></li>
                        <li><a href="<?= site_url('web/reservation')?>">Reservation</a></li>
                        <li><a href="<?= site_url('web/reservation')?>">Book Yours</a></li>
                    </ul>  
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="owl-cites-town owl-carousel">
                <div class="item">
                  <div class="thumb">
                    <img src="<?=base_url()?>assets/web/assets/images/cities-01.jpg" alt="">
                    <h4>Havana</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="<?=base_url()?>assets/web/assets/images/cities-02.jpg" alt="">
                    <h4>Kingston</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="<?=base_url()?>assets/web/assets/images/cities-03.jpg" alt="">
                    <h4>George Town</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="<?=base_url()?>assets/web/assets/images/cities-04.jpg" alt="">
                    <h4>Santo Domingo</h4>
                  </div>
                </div>
                <div class="item">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-weekly-offers owl-carousel">
            <div class="item">
              <div class="thumb">
                <img src="<?=base_url()?>assets/web/assets/images/offers-01.jpg" alt="">
                <div class="text">
            ...
            <div class="item">
              <div class="thumb">
                <img src="<?=base_url()?>assets/web/assets/images/offers-02.jpg" alt="">
                <div class="text">
            ...
            <div class="item">
              <div class="thumb">
                <img src="<?=base_url()?>assets/web/assets/images/offers-03.jpg" alt="">
                <div class="text">
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="<?=base_url()?>assets/web/assets/images/about-left-image.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-6">
  ...
  <script src="<?=base_url()?>assets/web/vendor/bootstrap/js/bootstrap.min.js"></script>

  <script src="<?=base_url()?>assets/web/assets/js/isotope.min.js"></script>
  <script src="<?=base_url()?>assets/web/assets/js/owl-carousel.js"></script>
  <script src="<?=base_url()?>assets/web/assets/js/wow.js"></script>
  <script src="<?=base_url()?>assets/web/assets/js/tabs.js"></script>
  <script src="<?=base_url()?>assets/web/assets/js/popup.js"></script>
  <script src="<?=base_url()?>assets/web/assets/js/custom.js"></script>
